...
const classes = [
  {
    ...
    description:'Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi exercitationem id necessitatibus.'
  },
  {
    name: 'Cardio',
        ...
        {classes.map((item,index)=>{
          return(
            <div className=' relative w-full h-[300px] lg:h-[485px] flex flex-col justify-center items-center' key={index}>
              ...
              <Image src={item.img} fill className=' object-cover alt' alt='' />
              <div className=' z-30 max-w-[380px] text-center flex flex-col items-center justify-center gap-4'>
                ...
                whileInView={'show'}
                viewport={{once:false, amount:0.2}}
                className='h3 text-red-600'>{item.name}</motion.h3>
                <motion.p
                variants={fadeIn('up', 0.6)}
                initial='hidden'
                whileInView={'show'}
